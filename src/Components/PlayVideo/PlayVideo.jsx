...
function PlayVideo() {
  ...
  const fetchOtherData = async () => {
    ...
    if (!apiData || !apiData.snippet?.channelId) return; // Ensure `apiData` is available
    try {
    ...
    <div className="play-video">
      ...
      <div className="publisher">
        ...
        <div>
          ...
          <span>
            {channelData ? `${value_converter(channelData.statistics.subscriberCount)} Subscribers` : '11M Subscribers'}
          </span>
        </div>
